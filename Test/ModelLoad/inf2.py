...
if __name__ == "__main__":
    ...
    folder_path = "/Users/v/SUN_RAT/I_AM_SEXY_QUEEN/BrainBuddy_BE/Test/IMG/카리나/frames_1754568023"
    image_sequence = [os.path.join(folder_path, f"frame_{i:04d}.jpg") for i in range(30)]

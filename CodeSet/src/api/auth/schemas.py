...
class SignUpRequest(BaseModel):
    ...
    user_id: str = Field(..., min_length=5, max_length=16)
    ...
    def check_fields(cls: Type["SignUpRequest"], values: Dict[str, Any]) -> Dict[str, Any]:
        required_fields = ["user_name", "user_id", "user_pw", "user_pw_confirm"]
    ...
    @classmethod
    def check_id_length(cls: Type["SignUpRequest"], id: str) -> str:
        if not (5 <= len(id) <= 16):
            raise ValueError(SignUpCode.INVALID_FORMAT.value.code)
        return id
